...
const multiple = higherFunction(function (a, b) {
  console.log(a * b)
})

const sum = higherFunction(function (a, b) {
  console.log(a + b)
})
...
// reduce function
const listNumber = [4 , 3, 3, 5, 1, 5];

const totalSum = listNumber.reduce((total, item) => total + item, 0)
const multipleSum = listNumber.reduce((total, item) => total * item, 1)
...
function multipleNumber(a: number) {
  return function (b) {
    console.log(a * b)
  }
}

const multiple2 = multipleNumber(2);
const multiple3 = multipleNumber(3);
const multiple4 = multipleNumber(4);
